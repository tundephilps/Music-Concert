  ...
  return (
    ...
    >
      <div className="relative ">
        <motion.img
          variants={item1}
          className=" w-full h-auto  max-h-[500px] object-cover opacity-20"
          src={concert}
          alt=""
        />
        <motion.div
        ...
        >
          ...
          <div className="flex items-baseline md:mt-16 mt-5 justify-center">
            <button className="md:px-7 px-3 max-md:text-sm md:py-2 py-1 border-2 hover:bg-white hover:text-black transition-all ease-in duration-200">
              See More
            </button>
          </div>
        </motion.div>

...
import afrobeats from "../assets/images/Afrobeats.jpg";
    ...
    <div>
      <div className="pt-28">
        ...
        >
          ...
          <motion.p
            className="text-center text-9xl pb-14 max-lg:text-7xl max-md:text-5xl"
            variants={item}
          >
            Your Heart&apos;s Music
          </motion.p>
          ...
          >
            The biggest, extraordinary and spread out African music festival all
            around the world , in cooperation with all the famous Afro-beats
            industry agencies in Africa and other outstanding talents
          </motion.p>
        </motion.div>
        <div className="mt-28 text-white">
          <div className="p-2 relative">
            ...
            >
              ...
              <motion.span
                variants={image}
                className="absolute top-4 right-4 md:text-xl text-sm"
              >
                Go and Buy the tickets
              </motion.span>
              <motion.span
                variants={image}
                className="absolute right-4 bottom-4 md:text-3xl text-sm"
              >
                Seoul, December 12
              </motion.span>
            </motion.div>
